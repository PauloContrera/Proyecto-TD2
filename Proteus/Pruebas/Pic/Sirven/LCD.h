...
#define D4          LATDbits.LATB5          // pin       
#define D5          LATDbits.LATB4          // pin      
#define D6          LATDbits.LATB3          // pin             
#define D7          LATDbits.LATB2          // pin

#define TRIS_D4     TRISDbits.TRISB5
#define TRIS_D5     TRISDbits.TRISB4
#define TRIS_D6     TRISDbits.TRISB3
#define TRIS_D7     TRISDbits.TRISB2

//******** Pines para el control del LCD **********

#define RS          LATDbits.LATB7           //Pin
#define EN          LATDbits.LATB6           //Pin

#define TRIS_RS     TRISDbits.TRISB7     
#define TRIS_EN     TRISDbits.TRISB6  
